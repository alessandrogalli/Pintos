...
struct thread
  {
    ...
    struct list_elem allelem;           /* List element for all threads list. */
		...
		struct semaphore * sema_blocked_on;
...
void recent_cpu_eval(struct thread *, void *);
void thread_mlfqs_evaluator (struct thread *);
...
void thread_update_priority (int);
